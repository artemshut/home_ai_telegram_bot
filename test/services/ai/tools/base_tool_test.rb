...
class Ai::Tools::BaseToolTest < ActiveSupport::TestCase
  class EchoTool < Ai::Tools::BaseTool
    ...
    def call(arguments, _context)
      Ai::ToolResult.ok(arguments["text"])
    end
  end
  ...
  test "tool_name raises NotImplementedError on base class" do
    assert_raises(NotImplementedError) { Ai::Tools::BaseTool.tool_name }
  end

  test "description raises NotImplementedError on base class" do
    assert_raises(NotImplementedError) { Ai::Tools::BaseTool.description }
  end

  test "schema raises NotImplementedError on base class" do
    assert_raises(NotImplementedError) { Ai::Tools::BaseTool.schema }
  end

  test "call raises NotImplementedError on base class" do
    assert_raises(NotImplementedError) { Ai::Tools::BaseTool.new.send(:call, {}, nil) }
  end
end
