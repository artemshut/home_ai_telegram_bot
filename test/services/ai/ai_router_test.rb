...
class Ai::AiRouterTest < ActiveSupport::TestCase
  setup do
  ...
  test "returns text on end_turn response" do
    ...
    Ai::ClaudeClient.stub(:new, fake_client) do
      result = Ai::AiRouter.new(
  ...
  test "executes tool call and continues to end_turn" do
    ...
    Ai::ClaudeClient.stub(:new, fake_client) do
      Ai::ToolRegistry.stub(:find, fake_tool) do
        result = Ai::AiRouter.new(
  ...
  test "returns fallback message when max depth exceeded" do
    ...
    fake_client = build_fake_client(Array.new(Ai::AiRouter::MAX_DEPTH, tool_use_response))
  ...
  test "records failed tool call on tool error" do
    ...
    Ai::ClaudeClient.stub(:new, fake_client) do
      Ai::ToolRegistry.stub(:find, exploding_tool) do
        Ai::AiRouter.new(
